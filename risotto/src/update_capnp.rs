...
pub mod update {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 325] = [
    ...
    pub static MEMBERS_BY_NAME : &[u16] = &[11,17,10,9,15,16,12,13,14,4,6,5,7,8,2,3,18,1,0];
